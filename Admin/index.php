...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.2/css/all.min.css" integrity="sha384-rvZcHfE8LdqqOlJqzY3H8gcDJo5RU8dUM8E2C5RcNInu7HLhq3oYl7KRvoqLOHp4" crossorigin="anonymous">
...
<body>
    ...
    <div class="header">
        ...
        <input type="search" name="search" id="input" class="form-control" placeholder="Search your product" required="required" title="">
        <button id="searchBtn"><i class="bi bi-search"></i><a href="#show" style="text-decoration: none ; color:aliceblue">Search</a></button>
    </div>
    <b>
        <p id="dis">10% OFF ON YOUR FIRST BUY NOW!</p>
    </b>
    <div class="bannertop fixed-top-style">
        <div class="bannertop">
            <ul><b>
                    <b>
    ...
    <div class="container text-center">
        ...
        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000" style="margin:25px 0px 25px 250px ;">
...
<div class="footer_introduce" style="background-color:#52BE80;">
    ...
    <footer class="bg-body-tertiary text-center">
        ...
        <div class="container p-4 pb-0">
            ...
            <section class="mb-4">
                <!-- Facebook -->
                <a data-mdb-ripple-init class="btn text-white btn-floating m-1" style="background-color: #3b5998;" href="#!" role="button"><i class="fab fa-facebook"></i></a>
                <!-- Google -->
